          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data" className="space-y-8">
                    ...
                    {formData.description.length > MAX_DESCRIPTION_LENGTH ? (
                      <>
                        <p className="text-gray-700">
                          {showFullDescription
                            ? formData.description
                            : `${formData.description.slice(0, MAX_DESCRIPTION_LENGTH)}...`}
                        </p>
                        <button
                          type="button"
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                required
              >
                <option value="" disabled selected className="text-gray-400">Select availability</option>
            ...
            <div className="space-y-2">
              ...
              {images.length > 0 && (
                <div className="mt-6">
                  <h3 className="text-sm font-medium text-gray-700 mb-4">Selected Images ({images.length})</h3>
